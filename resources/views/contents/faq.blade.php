    ...
    <div class="container relative">
        <div class="grid md:grid-cols-2 grid-cols-1 items-center gap-[30px]">
            ...
            <div class="lg:me-8 order-2 md:order-1">
                ...
                <p class="text-slate-400 max-w-xl mx-auto">Here you'll find key information on our Terms, Privacy Policy and support details to help you reach us anytime.</p>
                    ...
                    <div class="relative shadow-sm dark:shadow-gray-800 rounded-md overflow-hidden">
                        <h2 class="text-lg font-semibold" id="accordion-collapse-heading-1">
                            <button type="button" class="flex justify-between items-center p-5 w-full font-medium text-start" data-accordion-target="#accordion-collapse-body-1" aria-expanded="true" aria-controls="accordion-collapse-body-1">
                                <span>What can I do with this app?</span>
                        ...
                        <div id="accordion-collapse-body-1" class="hidden" aria-labelledby="accordion-collapse-heading-1">
                            <div class="p-5">
                                <p class="text-slate-400 dark:text-gray-400 text-sm">The app is deisgned to enhnace your experience as a member. <br>You can:<br>
                                a. View our latest menu items.<br>b. Receive exclusive notifications<br>c. Track your membership points<br></p><strong class="text-slate-400 dark:text-gray-400 text-sm">Please note: ordering and purchases are not available through the app. </strong>
                            </div>
                        </div>
                    </div>
